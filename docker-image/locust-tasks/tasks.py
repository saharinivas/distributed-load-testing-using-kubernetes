...
class MyTaskSequence(TaskSequence):
    ...
    def conceptconnect(self):
        ...
        response = self.client.get(url = "/concepts/connected/{Params[rnum][0]}?content_id={Params[rnum][1]}",name="conceptconnect",data=body, headers=headers)
    ...
    def conceptmoreconnect(self):
        ...
        response = self.client.get(url = "/concepts/more/{Params[rnum][0]}?content_id={Params[rnum][1]}",name="conceptmoreconnect",data=body,headers=headers)
    ...
    def getRelatedData(self):
        ...
        response = self.client.get(url = "/cg/related_data/{Params[rnum][0]}",name="getRelatedData",data=body, headers=headers)
    ...
    def getStatus(self):
        ...
        response = self.client.get(url = "/content-status/abc/Video?child_id={user_id['user_id']}",name="getStatus",headers=headers)
    ...
    def concept_prerequisites(self):
        ...
        response = self.client.get(url = "/concepts/prerequisites/{Params[rnum][0]}?content_id={Params[rnum][1]}",name="concept_prerequisites",data=body, headers=headers)
    ...
    def getContentDetails(self):
        ...
        # response = self.client.get(url = "/contentDetails/coobo/2758887",name="getContentDetails",data=json.dumps(contentdetails_data),
        # headers=headers)
        response = self.client.get(url = "/contentDetails/{Params[rnum][2]}/{Params[rnum][1]}",name="getContentDetails",data=json.dumps(contentdetails_data),
        headers=headers)
    ...
    def getConceptDetails(self):
        ...
        response = self.client.get(url = "/concept/content?conceptIds=new_KG2663,new_KG2081,{Params[rnum][0]}",name="getConceptDetails",data=body, headers=headers)
    ...
    def getnextConceptDetails(self):
        ...
        response = self.client.get(url = "/concepts/next/{Params[rnum][0]}",name="getnextConceptDetails",data=body, headers=headers)
